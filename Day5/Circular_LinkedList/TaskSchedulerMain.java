class TaskCLL {
    ...
    public void addFirst(int taskId, String taskName, int priority, String
    dueDate) {
    ...
    public void addLast(int taskId, String taskName, int priority, String
    dueDate) {
    if (tail == null) {
    ...
    public void add(int taskId, String taskName, int priority, String
    dueDate, int index) {
    if (index == 0) {
    addFirst(taskId, taskName, priority, dueDate);
    return;
